...
- **Content workspace** — send any card to a local workspace as Later / Analyze / Done, review grouped queues in a dedicated tab, and export the workspace as Markdown or CSV
