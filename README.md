...
- **Data sources** — Access Secret remains the Open Platform path; Settings supports Zhihu QR login, the host persists the read-only session locally with one-click clearing, and browser Cookie/profile reading has been removed from the user-facing UI
